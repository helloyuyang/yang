<?php
/* Smarty version 3.1.29, created on 2016-12-25 20:25:05
  from "D:\wamp\Apache24\htdocs\Project\1223\application\home\view\user\login.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_585fbaa1d212e1_26415712',
  'file_dependency' => 
  array (
    '5f396f853b16ffb1a544c1001bb278f74f0fb3ae' => 
    array (
      0 => 'D:\\wamp\\Apache24\\htdocs\\Project\\1223\\application\\home\\view\\user\\login.html',
      1 => 1482668667,
      2 => 'file',
    ),
  ),
...
function content_585fbaa1d212e1_26415712 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="aw-login-box">
		<div class="mod-body clearfix">
			<div class="content pull-left">
				...
				<h2>有问必答</h2>
				<form action="?m=home&c=User&a=verifyLogin" method="post" id="login_form">
					
					<ul>
						<li>
							<input type="text" name="username" placeholder="邮箱 / 用户名" class="form-control" id="aw-login-user-name"></li>
						<li>
						...
						<li class="last">
							<input type="submit" class="pull-right btn btn-large btn-primary" id="login_submit" value="登录"></a>
							<label>
