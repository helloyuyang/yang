<?php
/* Smarty version 3.1.29, created on 2017-01-05 22:02:08
  from "D:\wamp\Apache24\htdocs\Project\1229static\application\home\view\user\register.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_586e51e0ae5509_09988090',
  'file_dependency' => 
  array (
    '47acd9313fe80beefec648a8820f54d3744dbafb' => 
    array (
      0 => 'D:\\wamp\\Apache24\\htdocs\\Project\\1229static\\application\\home\\view\\user\\register.html',
      1 => 1483624927,
      2 => 'file',
    ),
  ),
...
function content_586e51e0ae5509_09988090 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
 ...
 type="text/javascript">
	function verifyUser() {
		...
		if(value.length>=5) {
			...
			if(res) {
				console.log('合法,继续');return true;
			} else {
				alert('用户名只能以字母开头');return false;
			}
		}
...
home/css/default/img/login_logo.png"></a>
	...
	<div class="mod-body">
		...
		action="?m=home&c=user&a=addHandle" class="aw-register-form">

			<ul>
				<li class="alert alert-danger hide error_message text-left"> <i class="icon icon-delete"></i> <em></em>
				</li>
				<li>
					<input type="text" onkeyup="return verifyUser()" id="username" value="" errortips="用户名长度不符合" tips="请输入一个 2-14 位的用户名" placeholder="用户名" name="user_name" class="aw-register-name form-control"></li>
				<li>
					<input type="text" onkeyup="verifyEmail()" id="email" errortips="邮箱格式不正确" value="" tips="请输入你常用的电子邮箱作为你的账号" name="email" placeholder="邮箱" class="aw-register-email form-control">
					<a href="?m=home&c=user&a=sendMessage" style="float:right">或短信验证</a>	
				</li>
				<li>
				...
				<li class="aw-register-verify">
					<img src="?m=home&c=user&a=showCaptcha" onclick="this.src='?m=home&c=user&a=showCaptcha&'"+Math.random()+"" 
					id="captcha" class="pull-right">

					<input type="text" placeholder="验证码" name="seccode_verify" class="form-control"></li>
				<li class="last">
					<label>
						<input type="checkbox" name="agreement_chk" value="agree" 
						checked="checked">我同意</label>
