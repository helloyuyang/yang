<?php
/* Smarty version 3.1.29, created on 2016-12-27 20:54:40
  from "D:\wamp\Apache24\htdocs\Project\1224login\application\admin\view\Question\add.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_586264903e52e6_83328021',
  'file_dependency' => 
  array (
    'a9bbbfd63b7ff19dcd9c828111fd319f966c1805' => 
    array (
      0 => 'D:\\wamp\\Apache24\\htdocs\\Project\\1224login\\application\\admin\\view\\Question\\add.html',
      1 => 1482817247,
      2 => 'file',
    ),
  ),
...
function content_586264903e52e6_83328021 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
admin/img/logo.png" class="pull-left">
    ...
    <div class="aw-content-wrap">
        <form  method="post" id="category_form" action="?m=admin&c=Question&a=addHandle" enctype="multipart/form-data">
        ...
        <div class="mod">
            ...
            <div class="tab-content mod-content">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td>
                            <div class="form-group">
                                <span class="col-sm-4 col-xs-4 control-label" style="text-align: center;margin-top: 10px ">采集网址:</span>
                                <div class="col-sm-8 col-xs-8">
                                    <input type="text" placeholder="默认网址" name="url" class="form-control">
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <input type="submit" class="btn btn-primary center-block" value="采集话题">
                        </td>
                    </tr>
                    </tfoot>
                </table>
